...
export interface UserInput<I, O> {
  reqType: ADL.ATypeExpr<I>;
  respType: ADL.ATypeExpr<O>;
}

const UserInput_AST : ADL.ScopedDecl =
  {"decl":{"annotations":[],"name":"UserInput","type_":{"kind":"struct_","value":{"fields":[{"annotations":[],"default":{"kind":"just","value":null},"name":"reqType","serializedName":"reqType","typeExpr":{"parameters":[{"parameters":[],"typeRef":{"kind":"typeParam","value":"I"}}],"typeRef":{"kind":"primitive","value":"TypeToken"}}},{"annotations":[],"default":{"kind":"just","value":null},"name":"respType","serializedName":"respType","typeExpr":{"parameters":[{"parameters":[],"typeRef":{"kind":"typeParam","value":"O"}}],"typeRef":{"kind":"primitive","value":"TypeToken"}}}],"typeParams":["I","O"]}},"version":{"kind":"nothing"}},"moduleName":"protoapp.apis.captest"};

export const snUserInput: ADL.ScopedName = {moduleName:"protoapp.apis.captest", name:"UserInput"};

export function texprUserInput<I, O>(texprI : ADL.ATypeExpr<I>, texprO : ADL.ATypeExpr<O>): ADL.ATypeExpr<UserInput<I, O>> {
  return {value : {typeRef : {kind: "reference", value : {moduleName : "protoapp.apis.captest",name : "UserInput"}}, parameters : [texprI.value, texprO.value]}};
}
