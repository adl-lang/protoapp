...
export interface RefreshApiRequests {
   ...
   */
  refresh: common_capability.HttpPost<common_http.Unit, protoapp_apis_types.RefreshResp>;
  /**
...
export function makeRefreshApiRequests(
  ...
  return {
    refresh: input.refresh === undefined ? {path : "/refresh", rateLimit : null, reqType : common_http.texprUnit(), respType : protoapp_apis_types.texprRefreshResp()} : input.refresh,
