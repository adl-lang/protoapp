...
const CapCall_AST : ADL.ScopedDecl =
  {"decl":{"annotations":[],"name":"CapCall","type_":{"kind":"struct_","value":{"fields":[{"annotations":[{"key":{"moduleName":"common.ui","name":"Disabled"},"value":null}],"default":{"kind":"nothing"},"name":"token","serializedName":"token","typeExpr":{"parameters":[],"typeRef":{"kind":"typeParam","value":"C"}}},{"annotations":[{"key":{"moduleName":"common.ui","name":"FormLabel"},"value":""}],"default":{"kind":"nothing"},"name":"payload","serializedName":"payload","typeExpr":{"parameters":[],"typeRef":{"kind":"typeParam","value":"P"}}}],"typeParams":["C","P"]}},"version":{"kind":"nothing"}},"moduleName":"common.capability"};
