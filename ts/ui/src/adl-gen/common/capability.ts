...
export interface DeliveryMethod_Jwt {
  kind: 'jwt';
}
...
export type DeliveryMethod = DeliveryMethod_None | DeliveryMethod_Jwt | DeliveryMethod_Header;
